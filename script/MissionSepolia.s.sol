...
contract MyScript is Script {
    function run() external {
        ...
        MissionCreator missionCreator = new MissionCreator(JB_CONTROLLER, JB_MULTI_TERMINAL, JB_PROJECTS, JB_TERMINAL_STORE, MOON_DAO_TEAM, MISSION_TABLE, MOON_DAO_TREASURY);
