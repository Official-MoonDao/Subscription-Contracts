...
contract MyScript is Script {
    ...
    function run() external {
        ...
        address ethAddress = 0xDc07FbCcF7Dd55014C8A2a605C671d01137B4937;
        if(block.chainid == 1) { //mainnet
            CrossChainMinter minter = CrossChainMinter(ethAddress);
            ...
            // eth
            uint32 ethEid = 30101;
            minter.setPeer(ethEid , addressToBytes32(ethAddress));
            eid = 30110;
