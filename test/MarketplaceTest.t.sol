...
import {MarketplaceTable} from "../src/tables/MarketplaceTable.sol";
...
contract MarketplaceTest is Test {
    ...
    function setUp() public {
      ...
      marketplaceTable = new MarketplaceTable("test");

      //vm.startPrank(user4);

        marketplaceTable.insertIntoTable("test", "test", "test", 0, "test", "test", "test");
        marketplaceTable.insertIntoTable("test", "test", "test", 0, "test", "test", "test");
        marketplaceTable.insertIntoTable("test", "test", "test", 0, "test", "test", "test");
        marketplaceTable.deleteFromTable(0,0);
        marketplaceTable.insertIntoTable("test", "test", "test", 1, "test", "test", "test");

      vm.stopPrank();
    }

    function testInsertTable() public {
        console.log("currId", marketplaceTable.currId());
        console.log("currId", marketplaceTable.currId());
        console.log('idToTeamId', marketplaceTable.idToTeamId(0));
        marketplaceTable.updateTable(3, "test", "test", "test", 1, "test", "test", "test");
    }
    function testUpdateTable() public {
        console.log('idToTeamId', marketplaceTable.idToTeamId(0));
        marketplaceTable.updateTable(0, "test", "test", "test", 0, "test", "test", "test");
    }
}
